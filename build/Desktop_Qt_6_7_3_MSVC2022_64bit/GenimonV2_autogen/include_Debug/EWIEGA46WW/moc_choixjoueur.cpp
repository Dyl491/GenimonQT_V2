...
void ChoixJoueur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ChoixJoueur::*)(int );
            if (_t _q_method = &ChoixJoueur::requestMenuChange; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ChoixJoueur::*)(const QString & );
            if (_t _q_method = &ChoixJoueur::sendNomJoueur; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ChoixJoueur::requestMenuChange(int _t1)
{
...
// SIGNAL 1
void ChoixJoueur::sendNomJoueur(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
